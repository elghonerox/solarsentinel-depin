...
1. **Start all servers** in the order listed above
2. **Visit the dashboard** to monitor solar panel status
3. **AI predictions** update every 30 seconds
4. **Normal readings** automatically mint ETK tokens
5. **All data** is logged to Hedera Consensus Service

...
- **Hedera Integration**: Logs sensor data to HCS (topic: 0.0.6804123) and mints ETK tokens for Normal readings.
- **Real-Time Dashboard**: Displays sensor readings, AI predictions, and metrics (14 ETK, 1.045 kg CO2 saved, $6,298 economic value).
...
bashcd solarsentinel-ai\solar-sentinel-backend
npm install
node backend-api-server.js
4. Integration Server (Port 4000):
